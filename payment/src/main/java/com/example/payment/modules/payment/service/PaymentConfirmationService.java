...
import com.example.payment.modules.payment.connector.BankConnector;
...
public class PaymentConfirmationService {
        ...
        public ConfirmPaymentResponse confirmPaymentIntent(
                ...
                // Call connector
                ConnectorResponse connectorResponse = bankConnector.authorize(
                                intent,
                ...
                // Persist final state ONCE
                paymentIntentRepository.save(intent);
                paymentTransactionRepository.save(txn);

                // Emit webhook AFTER COMMIT (CRITICAL)
                // Persist final state
